public class _240_SearchA2DMatrixII {
    ...
    public static boolean searchMatrix(int[][] matrix, int target) {
        ...
        while (row >= 0 && col < matrix[0].length) {
            ...
            if (matrix[row][col] > target) {
                System.out.println("Moving up (row--)");
                row--;
            } else if (matrix[row][col] < target) {
                System.out.println("Moving right (col++)");
                col++;
            } else {
                System.out.println("Found target at matrix[" + row + "][" + col + "]");
                return true;
            }
        }
    ...
    public static void testSearchMatrix(int[][] matrix, int target) {
        ...
        double razao = (double) (endTime2 - startTime2) / (endTime1 - startTime1);
        ...
        System.out.printf("search1/search2 = %.4f\n", razao);
    }
